{ lib, ... }:
{
  ...
  mcp_servers = {
    motion = {
      command = "/Users/swe/.hermes/bin/motion-mcp-hermes";
      args = [ ];
      timeout = 120;
      connect_timeout = 90;
      tools = {
        include = [
          ...
          "motion_get_comment"
          "motion_update_comment"
          "motion_delete_comment"
          "motion_list_custom_fields"
          "motion_create_custom_field"
          "motion_add_custom_field_to_task"
          "motion_add_custom_field_to_project"
          "motion_remove_custom_field_from_task"
          "motion_list_recurring_tasks"
          "motion_create_recurring_task"
          "motion_get_recurring_task"
          "motion_update_recurring_task"
